...
AudioProcessorValueTreeState::ParameterLayout SirialAudioProcessor::createParameterLayout()
{
    ...
    layout.add(std::make_unique<AudioParameterChoice>("mod_mode", "Modulation Mode", StringArray{ "Sine", "S&H", "Perlin", "Triangle", "Square"}, 0));
    ...
    layout.add(std::make_unique<AudioParameterChoice>("mod_rate_sync", "Modulation Rate Sync", StringArray{ "32/1", "16/1", "8/1", "4/1", "2/1", "1/1", "1/2", "1/4", "1/8", "1/16", "1/32"}, 5));
